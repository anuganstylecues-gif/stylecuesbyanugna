...
export default function Contact() {
  ...
  return (
    <section id="contact" style={{ background: 'var(--color-bg)', padding: '120px 5%' }}>
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        <div style={{ textAlign: 'center', marginBottom: '80px' }}>
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 style={{ fontSize: '3.5rem', marginBottom: '20px' }}>Get In <span style={{ fontStyle: 'italic', color: 'var(--color-accent-dark)' }}>Touch</span></h2>
      ...
      <style>{`
        ...
        @media (max-width: 600px) {
          .contact-cards-container { grid-template-columns: 1fr; gap: 30px; }
        }
      `}</style>
    </section>
  );
